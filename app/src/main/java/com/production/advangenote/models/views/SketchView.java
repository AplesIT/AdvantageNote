...
public class SketchView extends View implements OnTouchListener {
  ...
  public  static Logger logger = LoggerFactory.getLogger("SketchView.class");
  ...
  public boolean onTouch(View arg0, MotionEvent event) {
    ...
    switch (event.getAction()) {
      ...
      case MotionEvent.ACTION_UP:
        ...
        break;
      default:
        logger.error("Wrong element choosen: " + event.getAction());
    }
    return true;
  }
  ...
  public void setSize(int size, int eraserOrStroke) {
    switch (eraserOrStroke) {
      ...
      case ERASER:
        ...
        break;
      default:
        logger.error("Wrong element choosen: " + eraserOrStroke);
    }
