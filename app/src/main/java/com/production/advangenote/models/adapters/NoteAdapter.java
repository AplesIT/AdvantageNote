...
import com.production.advangenote.async.TextWorkerTask;
import com.production.advangenote.models.Attachment;
import com.production.advangenote.models.Note;
import com.production.advangenote.models.holders.NoteViewHolder;
...
import static com.production.advangenote.utils.ConstantsBase.TIMESTAMP_UNIX_EPOCH_FAR;

public class NoteAdapter extends RecyclerView.Adapter<NoteViewHolder> {
  private final static Logger logger = LoggerFactory.getLogger("NoteAdapter.class");
  ...
  private void initText(Note note, NoteViewHolder holder) {
    try {
      ...
      logger.info("Oversized tasks pool to load texts!", e);
    }
  }
