...
package com.production.advangenote.models.views;
...
import com.production.advangenote.models.listeners.AbsListViewScrollDetector;
import com.production.advangenote.models.listeners.OnFabItemClickedListener;

import static androidx.core.view.ViewCompat.animate;
import static com.production.advangenote.utils.ConstantsBase.FAB_ANIMATION_TIME;
...
public class Fab {
  ...
  public void setOverlay(int colorResurce) {
    View overlayView = new View(AdvantageNotes.getAppContext());
